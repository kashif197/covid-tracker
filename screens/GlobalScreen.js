    ...
    if (isLoading) {
        ...
        return (
            <View style={styles.startMain}>
                ...
                <ListItem
                        title={'New Confirmed'}
                        rightTitle={globalData.Global.NewConfirmed}
                        style={{ width: 420}}
                        bottomDivider
                    />
                    <ListItem
                        title={'Total Confirmed'}
                        rightTitle={globalData.Global.TotalConfirmed}
                        style={{ width: 420}}
                        bottomDivider
                    />
                    <ListItem
                        title={'New Deaths'}
                        rightTitle={globalData.Global.NewDeaths}
                        style={{ width: 420}}
                        bottomDivider
                    />
                    <ListItem
                        title={'Total Deaths'}
                        rightTitle={globalData.Global.TotalDeaths}
                        style={{ width: 420}}
                        bottomDivider
                    />
                    <ListItem
                        title={'New Recovered'}
                        rightTitle={globalData.Global.NewRecovered}
                        style={{ width: 420}}
                        bottomDivider
                    />
                    <ListItem
                        title={'Total Recovered'}
                        rightTitle={globalData.Global.TotalRecovered}
                        style={{ width: 420}}
                        bottomDivider
                    />
            </View>
